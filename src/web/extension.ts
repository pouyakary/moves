...
export function activate(context: vscode.ExtensionContext) {
  ...
  registerCommandHandler(
    "moves.moveCursorUnderNextColumnAbove",
    actions.cursorUnderNextColumnAbove,
  );
  registerCommandHandler(
    "moves.moveCursorUnderNextColumnBelow",
    actions.cursorUnderNextColumnBelow,
  );

  registerCommandHandler(
    "moves.moveCursorUnderPreviousColumnAbove",
    actions.cursorUnderPreviousColumnAbove,
  );
  registerCommandHandler(
    "moves.moveCursorUnderPreviousColumnBelow",
    actions.cursorUnderPreviousColumnBelow,
  );

  registerCommandHandler(
    "moves.selectAllWordNeighborLines",
